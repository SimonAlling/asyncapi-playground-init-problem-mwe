...
import '@fortawesome/fontawesome-svg-core/styles.css'; // Copied from playground's index.tsx, which has been removed.
...
class Playground extends Component<{}, State> {
  ...
  render() {
    ...
    return (
      <PlaygroundWrapper>
        {/* Navigation removed because it doesn't make sense in our layout. */}
        <SplitWrapper>
          <CodeEditorsWrapper>
            <Tabs
